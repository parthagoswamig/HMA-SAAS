...
const AuditPage = () => {
  ...
  const loadAuditLogs = useCallback(async () => {
    ...
    try {
      ...
      const response = await apiFetch(`${API_BASE_URL}/audit/logs?${params}`, {
        method: 'GET',
        headers: {
  ...
  const loadStatistics = useCallback(async () => {
    try {
      ...
      const response = await apiFetch(`${API_BASE_URL}/audit/statistics`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const markAsReviewed = async (logId: string) => {
    try {
      const response = await apiFetch(`${API_BASE_URL}/audit/logs/${logId}/reviewed`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
