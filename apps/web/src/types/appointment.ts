...
export interface Appointment extends BaseEntity {
  ...
  patient: Patient;
  doctor: Staff & { user?: { firstName: string; lastName: string }; department?: { name: string } };
  appointmentDate: Date;
  appointmentTime: string;
  startTime?: string | Date; // Backend uses startTime
  endTime?: string | Date; // Backend uses endTime
