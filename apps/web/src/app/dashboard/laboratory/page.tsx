...
const LaboratoryManagement = () => {
  ...
  const [scanSampleOpened, { open: openScanSample, close: closeScanSample }] = useDisclosure(false);
  const [registerSampleOpened, { open: openRegisterSample, close: closeRegisterSample }] = useDisclosure(false);
  const [addEquipmentOpened, { open: openAddEquipment, close: closeAddEquipment }] = useDisclosure(false);
  const [addQCTestOpened, { open: openAddQCTest, close: closeAddQCTest }] = useDisclosure(false);
  ...
  const fetchAllData = async () => {
    try {
      _setLoading(true);
      _setError(null);
      await Promise.all([fetchLabTests(), fetchLabOrders(), fetchLabStats(), fetchPatients()]);
    } catch (err: any) {
  ...
  const fetchLabTests = async () => {
    try {
      ...
      console.log('✅ [DEBUG] Lab Tests API response:', response);
  ...
  const fetchLabOrders = async () => {
    try {
      const filters: any = {};
      if (selectedPatient) filters.patientId = selectedPatient;
      if (selectedStatus) filters.status = selectedStatus;
      if (searchQuery) filters.search = searchQuery;
      
      const response = (await laboratoryService.getLabOrders(filters)) as any;
      console.log('✅ [DEBUG] Lab Orders API response:', response);
    ...
    <Container size="xl" py={{ base: 'xs', sm: 'sm', md: 'md' }} px={{ base: 'xs', sm: 'sm', md: 'md', lg: 'lg' }}>
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 sm:gap-4 mb-4 sm:mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
          ...
          <Button variant="light" leftSection={<IconFlask size={16} />} onClick={openAddOrder} className="w-full sm:w-auto" size="sm">
            New Order
          </Button>
        </div>
      </div>
        ...
        <Tabs.Panel value="samples">
          <Paper p="md" radius="md" withBorder mt="md">
            <Group justify="space-between" mb="lg">
              ...
              <Group>
                <Button leftSection={<IconBarcode size={16} />} variant="light" onClick={openScanSample}>
                  Scan Sample
                </Button>
                <Button leftSection={<IconFlask size={16} />} onClick={openRegisterSample}>Register Sample</Button>
              </Group>
            </Group>
        ...
        <Tabs.Panel value="equipment">
          <Paper p="md" radius="md" withBorder mt="md">
            <Group justify="space-between" mb="lg">
              ...
              <Button leftSection={<IconPlus size={16} />} onClick={openAddEquipment}>Add Equipment</Button>
            </Group>
        ...
        <Tabs.Panel value="qc">
          <Paper p="md" radius="md" withBorder mt="md">
            <Group justify="space-between" mb="lg">
              ...
              <Button leftSection={<IconPlus size={16} />} onClick={openAddQCTest}>Add QC Test</Button>
            </Group>
      ...
      {/* New Order Modal */}
      <Modal opened={addOrderOpened} onClose={closeAddOrder} title="New Laboratory Order" size="lg">
        <Stack gap="md">
          <Select
            label="Patient"
          ...
          <Select
            ...
            data={labTests.map(t => ({ value: t.id, label: `${t.testName} (${t.testCode})` }))}
            searchable
            required
          />
          <Select
            ...
            required
          />
          <Textarea label="Clinical Notes" placeholder="Enter clinical notes" rows={3} />
          <Group justify="flex-end">
            <Button variant="light" onClick={closeAddOrder}>Cancel</Button>
            <Button onClick={() => {
              notifications.show({
                title: 'Order Created',
                message: 'Laboratory order has been created successfully',
                color: 'green',
              });
              closeAddOrder();
            }}>Create Order</Button>
      ...
      {/* Scan Sample Modal */}
      <Modal opened={scanSampleOpened} onClose={closeScanSample} title="Scan Sample Barcode" size="md">
        <Stack gap="md">
          <Text c="dimmed" size="sm">Scan the barcode on the sample container</Text>
          <TextInput
            label="Barcode"
          ...
          <Alert color="blue" icon={<IconAlertCircle size={16} />}>
            Position the barcode scanner and scan the sample label
          </Alert>
          <Group justify="flex-end">
            <Button variant="light" onClick={closeScanSample}>Cancel</Button>
            <Button onClick={() => {
              notifications.show({
                title: 'Sample Scanned',
                message: 'Sample has been scanned successfully',
                color: 'green',
              });
              closeScanSample();
            }}>Confirm</Button>
      ...
      <Modal opened={registerSampleOpened} onClose={closeRegisterSample} title="Register New Sample" size="lg">
        <Stack gap="md">
          <Select
            label="Order"
            placeholder="Select laboratory order"
            data={labOrders.map(o => ({ value: o.id, label: o.orderNumber }))}
            searchable
            required
          />
          <SimpleGrid cols={2}>
            <Select
              ...
              required
            />
            <TextInput label="Sample ID" placeholder="Auto-generated" disabled />
          </SimpleGrid>
          <SimpleGrid cols={2}>
            <TextInput label="Collection Date" type="datetime-local" required />
            <TextInput label="Collected By" placeholder="Enter name" required />
          </SimpleGrid>
          <Textarea label="Collection Notes" placeholder="Enter notes" rows={3} />
          <Group justify="flex-end">
            <Button variant="light" onClick={closeRegisterSample}>Cancel</Button>
            <Button onClick={() => {
              notifications.show({
                title: 'Sample Registered',
                message: 'Sample has been registered successfully',
                color: 'green',
              });
              closeRegisterSample();
      ...
      {/* Add Equipment Modal */}
      <Modal opened={addEquipmentOpened} onClose={closeAddEquipment} title="Add Laboratory Equipment" size="lg">
        <Stack gap="md">
          <SimpleGrid cols={2}>
            <TextInput label="Equipment Name" placeholder="Enter name" required />
            <TextInput label="Model Number" placeholder="Enter model" required />
          </SimpleGrid>
          <SimpleGrid cols={2}>
            <Select
              ...
              required
            />
            <TextInput label="Serial Number" placeholder="Enter serial" required />
          </SimpleGrid>
          <SimpleGrid cols={2}>
            <TextInput label="Manufacturer" placeholder="Enter manufacturer" required />
            <TextInput label="Purchase Date" type="date" required />
          </SimpleGrid>
          <Textarea label="Description" placeholder="Enter description" rows={3} />
          <Group justify="flex-end">
            <Button variant="light" onClick={closeAddEquipment}>Cancel</Button>
            <Button onClick={() => {
              notifications.show({
                title: 'Equipment Added',
                message: 'Laboratory equipment has been added successfully',
                color: 'green',
              });
              closeAddEquipment();
      ...
      {/* Add QC Test Modal */}
      <Modal opened={addQCTestOpened} onClose={closeAddQCTest} title="Add Quality Control Test" size="lg">
        <Stack gap="md">
          <Select
            label="Test"
            placeholder="Select test"
          ...
          <SimpleGrid cols={2}>
            <Select
              ...
              required
            />
            <TextInput label="Lot Number" placeholder="Enter lot number" required />
          </SimpleGrid>
          <SimpleGrid cols={2}>
            <NumberInput label="Expected Value" placeholder="Enter value" required />
            <NumberInput label="Acceptable Range (±)" placeholder="Enter range" required />
          </SimpleGrid>
          <Textarea label="Notes" placeholder="Enter QC notes" rows={3} />
          <Group justify="flex-end">
            <Button variant="light" onClick={closeAddQCTest}>Cancel</Button>
            <Button onClick={() => {
              notifications.show({
                title: 'QC Test Added',
                message: 'Quality control test has been added successfully',
                color: 'green',
              });
              closeAddQCTest();
            }}>Add QC Test</Button>
      ...
      {/* Order Detail Modal */}
      <Modal opened={orderDetailOpened} onClose={closeOrderDetail} title="Order Details" size="lg">
        {selectedOrder && (
          <Stack gap="md">
            <Group justify="space-between">
              <div>
                <Text fw={600} size="lg">{selectedOrder.orderNumber}</Text>
                <Text c="dimmed" size="sm">
                  {selectedOrder.patient.firstName} {selectedOrder.patient.lastName}
                </Text>
              </div>
              <Badge color="blue">{selectedOrder.status}</Badge>
            </Group>
            <Divider />
            <SimpleGrid cols={2}>
              <div>
                <Text size="sm" c="dimmed">Tests</Text>
                <Text fw={500}>{selectedOrder.tests?.length || 0} test(s)</Text>
              </div>
              <div>
                <Text size="sm" c="dimmed">Priority</Text>
                <Text fw={500}>{selectedOrder.priority || 'Routine'}</Text>
              </div>
              <div>
              ...
              <div>
                ...
                <Text fw={500}>{selectedOrder.status}</Text>
              </div>
            </SimpleGrid>
            <Group justify="flex-end">
              <Button variant="light" onClick={closeOrderDetail}>Close</Button>
      ...
      {/* Sample Detail Modal */}
      <Modal opened={sampleDetailOpened} onClose={closeSampleDetail} title="Sample Details" size="lg">
        {selectedSample && (
          <Stack gap="md">
            <Group justify="space-between">
              <div>
                <Text fw={600} size="lg">{selectedSample.sampleId}</Text>
                <Text c="dimmed" size="sm">{selectedSample.sampleType}</Text>
              </div>
              <Badge color="blue">{selectedSample.status}</Badge>
            </Group>
            <Divider />
            <SimpleGrid cols={2}>
              <div>
                <Text size="sm" c="dimmed">Collection Date</Text>
                <Text fw={500}>{new Date(selectedSample.collectionDate).toLocaleString()}</Text>
              </div>
              <div>
                <Text size="sm" c="dimmed">Collected By</Text>
                <Text fw={500}>{selectedSample.collectedBy || 'N/A'}</Text>
              </div>
              <div>
                <Text size="sm" c="dimmed">Status</Text>
                <Text fw={500}>{selectedSample.status}</Text>
              </div>
              <div>
                <Text size="sm" c="dimmed">Sample ID</Text>
                <Text fw={500}>{selectedSample.sampleId || 'N/A'}</Text>
              </div>
            </SimpleGrid>
            {selectedSample.notes && (
              <div>
                <Text size="sm" c="dimmed" mb="xs">Notes</Text>
                <Text size="sm">{selectedSample.notes}</Text>
              </div>
            )}
            <Group justify="flex-end">
              <Button variant="light" onClick={closeSampleDetail}>Close</Button>
