  ...
  useEffect(() => {
    const fetchSubscriptionData = async () => {
      try {
        ...
        const planResponse = await apiFetch(`${baseUrl}/subscription/current`, {
          credentials: 'include',
        });
        ...
        const usageResponse = await apiFetch(`${baseUrl}/subscription/usage`, {
          credentials: 'include',
        });
        ...
        const invoicesResponse = await apiFetch(`${baseUrl}/subscription/invoices`, {
          credentials: 'include',
        });
        ...
        const plansResponse = await apiFetch(`${baseUrl}/subscription/plans`, {
          credentials: 'include',
        });
