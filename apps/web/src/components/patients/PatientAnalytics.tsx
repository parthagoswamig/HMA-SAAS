              ...
              <div>
                <Group justify="space-between" mb="xs">
                  ...
                  <Text size="sm" fw={500}>
                    ...
                    {(((stats.genderDistribution?.male || 0) / derivedStats.totalPatients) * 100).toFixed(
                      1
                    )}
                    %)
                  </Text>
                ...
                <Progress
                  value={((stats.genderDistribution?.male || 0) / derivedStats.totalPatients) * 100}
                  color="blue"
                  size="lg"
                />
              </div>
              ...
              <div>
                <Group justify="space-between" mb="xs">
                  ...
                  <Text size="sm" fw={500}>
                    ...
                    {(((stats.genderDistribution?.female || 0) / derivedStats.totalPatients) * 100).toFixed(
                      1
                    )}
                    %)
                  </Text>
                ...
                <Progress
                  value={((stats.genderDistribution?.female || 0) / derivedStats.totalPatients) * 100}
                  color="pink"
                  size="lg"
                />
              </div>

              {(stats.genderDistribution?.other || 0) > 0 && (
                <div>
                  <Group justify="space-between" mb="xs">
                    ...
                    <Text size="sm" fw={500}>
                      ...
                      {(
                        ((stats.genderDistribution?.other || 0) / derivedStats.totalPatients) *
                        100
                      ).toFixed(1)}
                      %)
                    </Text>
                  ...
                  <Progress
                    value={((stats.genderDistribution?.other || 0) / derivedStats.totalPatients) * 100}
                    color="gray"
                    size="lg"
                  />
                </div>
      ...
      <Paper p="md" withBorder>
        ...
        <Group justify="center" mb="md">
          <RingProgress
            ...
            sections={[
              {
                value: ((stats.insuranceDistribution?.insured || 0) / derivedStats.totalPatients) * 100,
                color: 'green',
                tooltip: 'Insured Patients',
              },
              {
                value: ((stats.insuranceDistribution?.uninsured || 0) / derivedStats.totalPatients) * 100,
                color: 'red',
              ...
              <Center>
                <div>
                  <Text size="xl" fw={700} ta="center" c="green">
                    {(
                      ((stats.insuranceDistribution?.insured || 0) / derivedStats.totalPatients) *
                      100
                    ).toFixed(1)}
                    %
                  </Text>
        ...
        <Grid>
          <Grid.Col span={6}>
            <Group justify="space-between">
              ...
              <Text size="sm" fw={500}>
                {stats.insuranceDistribution?.insured || 0}
              </Text>
            </Group>
          </Grid.Col>
          <Grid.Col span={6}>
            <Group justify="space-between">
              ...
              <Text size="sm" fw={500}>
                {stats.insuranceDistribution?.uninsured || 0}
              </Text>
            </Group>
          </Grid.Col>
        </Grid>
