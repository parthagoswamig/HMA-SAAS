...
export class PatientsService {
  ...
  async create(createPatientDto: CreatePatientDto, tenantId: string) {
    try {
      ...
      console.log('🔵 [SERVICE] Patient data:', createPatientDto);
      
      const mrn = await this.generateMedicalRecordNumber(tenantId);
      console.log('🔵 [SERVICE] Generated MRN:', mrn);
      ...
      console.log('🔵 [SERVICE] About to create patient in database with data:', data);
      ...
      console.log('✅ [SERVICE] Patient created in database:', patientRaw.id);
